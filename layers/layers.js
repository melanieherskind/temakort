...
var format_folkeskoler2_5 = new ol.format.GeoJSON();
var features_folkeskoler2_5 = format_folkeskoler2_5.readFeatures(json_folkeskoler2_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_folkeskoler2_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_folkeskoler2_5.addFeatures(features_folkeskoler2_5);
var lyr_folkeskoler2_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_folkeskoler2_5, 
                style: style_folkeskoler2_5,
                popuplayertitle: 'folkeskoler2',
                interactive: true,
                title: '<img src="styles/legend/folkeskoler2_5.png" /> folkeskoler2'
            });
var format_EUDHvidovre_6 = new ol.format.GeoJSON();
var features_EUDHvidovre_6 = format_EUDHvidovre_6.readFeatures(json_EUDHvidovre_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EUDHvidovre_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EUDHvidovre_6.addFeatures(features_EUDHvidovre_6);
var lyr_EUDHvidovre_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EUDHvidovre_6, 
                style: style_EUDHvidovre_6,
                popuplayertitle: 'EUD Hvidovre',
                interactive: true,
                title: '<img src="styles/legend/EUDHvidovre_6.png" /> EUD Hvidovre'
            });
...
var format_Lger_9 = new ol.format.GeoJSON();
var features_Lger_9 = format_Lger_9.readFeatures(json_Lger_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Lger_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lger_9.addFeatures(features_Lger_9);
var lyr_Lger_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Lger_9, 
                style: style_Lger_9,
                popuplayertitle: 'Læger',
                interactive: true,
                title: '<img src="styles/legend/Lger_9.png" /> Læger'
            });
var format_Rdhus_10 = new ol.format.GeoJSON();
var features_Rdhus_10 = format_Rdhus_10.readFeatures(json_Rdhus_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Rdhus_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Rdhus_10.addFeatures(features_Rdhus_10);
var lyr_Rdhus_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Rdhus_10, 
                style: style_Rdhus_10,
                popuplayertitle: 'Rådhus',
                interactive: true,
                title: '<img src="styles/legend/Rdhus_10.png" /> Rådhus'
            });
...
lyr_Positronnolabelsretina_0.setVisible(true);lyr_Voyagernolabelsretina_1.setVisible(true);lyr_lokalplaner_2.setVisible(true);lyr_Frededeomrder_3.setVisible(true);lyr_strandbeskyttelse_4.setVisible(true);lyr_folkeskoler2_5.setVisible(true);lyr_EUDHvidovre_6.setVisible(true);lyr_Togstationer_7.setVisible(true);lyr_Hospital_8.setVisible(true);lyr_Lger_9.setVisible(true);lyr_Rdhus_10.setVisible(true);lyr_kommuneplan_11.setVisible(true);
var layersList = [lyr_Positronnolabelsretina_0,lyr_Voyagernolabelsretina_1,lyr_lokalplaner_2,lyr_Frededeomrder_3,lyr_strandbeskyttelse_4,lyr_folkeskoler2_5,lyr_EUDHvidovre_6,lyr_Togstationer_7,lyr_Hospital_8,lyr_Lger_9,lyr_Rdhus_10,lyr_kommuneplan_11];
...
lyr_folkeskoler2_5.set('fieldAliases', {'Skolenavn': 'Skolenavn', 'Adresse': 'Adresse', 'By': 'By', 'Hjemmeside': 'Hjemmeside', 'result_num': 'result_num', 'osm_id': 'osm_id', 'display_na': 'display_na', 'category': 'category', 'type': 'type', 'latlong': 'latlong', });
lyr_EUDHvidovre_6.set('fieldAliases', {'fid': 'fid', 'Navn': 'Navn', 'Adresse': 'Adresse', 'By': 'By', 'Hjemmeside': 'Hjemmeside', 'Telefonnum': 'Telefonnum', 'result_num': 'result_num', 'osm_id': 'osm_id', 'display_na': 'display_na', 'category': 'category', 'type': 'type', 'latlong': 'latlong', });
...
lyr_Hospital_8.set('fieldAliases', {'fid': 'fid', 'Navn': 'Navn', 'Adresse': 'Adresse', 'By': 'By', 'Hjemmeside': 'Hjemmeside', 'Telefonnum': 'Telefonnum', 'result_num': 'result_num', 'osm_id': 'osm_id', 'display_na': 'display_na', 'category': 'category', 'type': 'type', 'latlong': 'latlong', });
lyr_Lger_9.set('fieldAliases', {'fid': 'fid', 'Navn': 'Navn', 'Adresse': 'Adresse', 'By': 'By', 'Hjemmeside': 'Hjemmeside', 'Telefonnum': 'Telefonnum', 'result_num': 'result_num', 'osm_id': 'osm_id', 'display_na': 'display_na', 'category': 'category', 'type': 'type', 'latlong': 'latlong', });
lyr_Rdhus_10.set('fieldAliases', {'fid': 'fid', 'Navn': 'Navn', 'Adresse': 'Adresse', 'By': 'By', 'Hjemmeside': 'Hjemmeside', 'Telefonnum': 'Telefonnum', 'result_num': 'result_num', 'osm_id': 'osm_id', 'display_na': 'display_na', 'category': 'category', 'type': 'type', 'latlong': 'latlong', });
...
lyr_lokalplaner_2.set('fieldImages', {'fid': '', 'planid': 'TextEdit', 'plannr': 'TextEdit', 'plannavn': 'TextEdit', 'datovedt': 'TextEdit', 'doklink': 'TextEdit', 'anvendelse': 'TextEdit', });
...
lyr_folkeskoler2_5.set('fieldImages', {'Skolenavn': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'TextEdit', 'Hjemmeside': 'TextEdit', 'result_num': 'Hidden', 'osm_id': 'Hidden', 'display_na': 'Hidden', 'category': 'Hidden', 'type': 'Hidden', 'latlong': 'Hidden', });
lyr_EUDHvidovre_6.set('fieldImages', {'fid': '', 'Navn': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'TextEdit', 'Hjemmeside': 'TextEdit', 'Telefonnum': 'TextEdit', 'result_num': 'Hidden', 'osm_id': 'Hidden', 'display_na': 'Hidden', 'category': 'Hidden', 'type': 'Hidden', 'latlong': 'Hidden', });
...
lyr_Hospital_8.set('fieldImages', {'fid': '', 'Navn': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'TextEdit', 'Hjemmeside': 'TextEdit', 'Telefonnum': 'TextEdit', 'result_num': 'TextEdit', 'osm_id': 'TextEdit', 'display_na': 'TextEdit', 'category': 'TextEdit', 'type': 'TextEdit', 'latlong': 'TextEdit', });
lyr_Lger_9.set('fieldImages', {'fid': '', 'Navn': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'TextEdit', 'Hjemmeside': 'TextEdit', 'Telefonnum': 'TextEdit', 'result_num': 'TextEdit', 'osm_id': 'TextEdit', 'display_na': 'TextEdit', 'category': 'TextEdit', 'type': 'TextEdit', 'latlong': 'TextEdit', });
lyr_Rdhus_10.set('fieldImages', {'fid': '', 'Navn': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'TextEdit', 'Hjemmeside': 'TextEdit', 'Telefonnum': 'TextEdit', 'result_num': 'Hidden', 'osm_id': 'Hidden', 'display_na': 'Hidden', 'category': 'Hidden', 'type': 'Hidden', 'latlong': 'Hidden', });
...
lyr_lokalplaner_2.set('fieldLabels', {'fid': 'no label', 'planid': 'inline label - always visible', 'plannr': 'inline label - always visible', 'plannavn': 'inline label - always visible', 'datovedt': 'inline label - always visible', 'doklink': 'inline label - always visible', 'anvendelse': 'inline label - always visible', });
...
lyr_folkeskoler2_5.set('fieldLabels', {'Skolenavn': 'inline label - always visible', 'Adresse': 'inline label - always visible', 'By': 'inline label - always visible', 'Hjemmeside': 'inline label - always visible', });
lyr_EUDHvidovre_6.set('fieldLabels', {'fid': 'no label', 'Navn': 'no label', 'Adresse': 'no label', 'By': 'no label', 'Hjemmeside': 'no label', 'Telefonnum': 'no label', });
lyr_Togstationer_7.set('fieldLabels', {'Name': 'inline label - always visible', });
lyr_Hospital_8.set('fieldLabels', {'fid': 'no label', 'Navn': 'no label', 'Adresse': 'no label', 'By': 'no label', 'Hjemmeside': 'no label', 'Telefonnum': 'no label', 'result_num': 'no label', 'osm_id': 'no label', 'display_na': 'no label', 'category': 'no label', 'type': 'no label', 'latlong': 'no label', });
lyr_Lger_9.set('fieldLabels', {'fid': 'no label', 'Navn': 'no label', 'Adresse': 'no label', 'By': 'no label', 'Hjemmeside': 'no label', 'Telefonnum': 'no label', 'result_num': 'no label', 'osm_id': 'no label', 'display_na': 'no label', 'category': 'no label', 'type': 'no label', 'latlong': 'no label', });
lyr_Rdhus_10.set('fieldLabels', {'fid': 'no label', 'Navn': 'no label', 'Adresse': 'no label', 'By': 'no label', 'Hjemmeside': 'no label', 'Telefonnum': 'no label', });
lyr_kommuneplan_11.set('fieldLabels', {'fid': 'no label', 'oid': 'no label', 'id': 'no label', 'planid': 'no label', 'objektkode': 'no label', 'komnr': 'no label', 'plannavn': 'no label', 'doklink': 'no label', 'datoforsl': 'no label', 'datovedt': 'no label', 'datoaflyst': 'no label', 'datoikraft': 'no label', 'datoslut': 'no label', 'aktuel': 'no label', 'datooprt': 'no label', 'datoopdt': 'no label', 'status': 'no label', 'datostart': 'no label', 'glkomnr': 'no label', 'kommunenavn': 'no label', 'glkomnavn': 'no label', 'glkomnavn_besk': 'no label', });
lyr_kommuneplan_11.on('precompose', function(evt) {
